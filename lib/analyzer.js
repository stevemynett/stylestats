...
Analyzer.prototype.analyze = function () {
  ...
  // specificity
  if (this.options.idSelectors && this.options.classSelectors && this.options.specificity) {
    analysis.specificity = (selectorAnalysis.idSelectors * 100 + selectorAnalysis.classSelectors * 10) / this.selectors.length;
  }
